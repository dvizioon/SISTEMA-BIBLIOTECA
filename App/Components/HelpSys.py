...
def scriptSysHelp(frame):
    ...
    - Como começar: https://www.example.com/como-comecar
    - Como criar uma nova conta: https://www.example.com/criar-conta
    - Como usar os recursos avançados: https://www.example.com/recursos-avancados
